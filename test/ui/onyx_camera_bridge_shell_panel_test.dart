...
import 'package:omnix_dashboard/ui/onyx_camera_bridge_shell_panel.dart';
import 'package:omnix_dashboard/ui/onyx_camera_bridge_tone_resolver.dart';

void main() {
  testWidgets('camera bridge shell panel renders agent variant', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: OnyxCameraBridgeShellPanel(
            ...
            snapshot: null,
            accents: const OnyxCameraBridgeSurfaceAccents(
              status: Color(0xFF67E8F9),
  ...
  testWidgets('camera bridge shell panel renders admin variant', (
    tester,
  ) async {
    final surfaceState = OnyxAgentCameraBridgeSurfaceState(
      runtimeState: const OnyxAgentCameraBridgeRuntimeState(
      ...
      MaterialApp(
        home: Scaffold(
          body: OnyxCameraBridgeShellPanel(
            ...
            onCopy: null,
            variant: OnyxCameraBridgeShellPanelVariant.admin,
          ),
        ),
      ),
    );
