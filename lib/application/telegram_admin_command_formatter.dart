...
class TelegramAdminCommandFormatter {
  ...
  static String morningGovernance({
    ...
    String? globalReadinessShadowPostureSummary,
    String? globalReadinessShadowHistoryHeadline,
    String? globalReadinessShadowHistorySummary,
    String? globalReadinessShadowStrengthHistorySummary,
    ...
    String? syntheticWarRoomPromotionExecutionSummary,
    ...
    final readinessShadowPostureSummary =
        globalReadinessShadowPostureSummary?.trim() ?? '';
    ...
    final readinessShadowStrengthHistorySummary =
        globalReadinessShadowStrengthHistorySummary?.trim() ?? '';
    ...
    final tomorrowPostureCase =
        currentShiftTomorrowPostureCaseFileCommand?.trim() ?? '';
    ...
    final warRoomPromotionExecutionSummary =
        syntheticWarRoomPromotionExecutionSummary?.trim() ?? '';
    ...
    final readinessSection = readinessReview.isEmpty && readinessCase.isEmpty
        ...
        : '---\n\n'
              ...
              '${readinessShadowPostureSummary.isEmpty ? '' : '• <b>Shadow posture:</b> ${_escapeHtml(readinessShadowPostureSummary)}\n'}'
              ...
              '${readinessShadowStrengthHistorySummary.isEmpty ? '' : '• <b>Shadow strength:</b> ${_escapeHtml(readinessShadowStrengthHistorySummary)}\n'}'
    ...
    final warRoomSection = warRoomHeadline.isEmpty && warRoomSummary.isEmpty
        ...
        : '---\n\n'
              ...
              '${warRoomPromotionExecutionSummary.isEmpty ? '' : '• <b>Promotion execution:</b> ${_escapeHtml(warRoomPromotionExecutionSummary)}\n'}'
